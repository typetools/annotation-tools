...
annotations and also the extended annotations proposed in JSR 308~\cite{JSR308-webpage-201110}.
...
\qquad    \bnfcmt Using \code{javap -s} makes it easy to find the signature.\\
...
\qquad    \bnfcmt The integer list here contains the values of the
  ``\ahref{http://types.cs.washington.edu/jsr308/specification/java-annotation-design.html#class-file:ext:type_path}{type\_path}''
  structure~\cite{JSR308-webpage-201110}. \\ % Section 3.4
...
\qquad    \bnfcmt is the type index of an intersection type~\cite{JSR308-webpage-201110}. \\
...
\qquad    \bnfcmt The integer is the offset field of the annotation~\cite{JSR308-webpage-201110}. \\
...
\qquad    \bnfcmt the optional second integer is the type index of an intersection type~\cite{JSR308-webpage-201110}. \\
\qquad    \bnfcmt The type index defaults to zero if not specified. \\
...
\bnfnt{type-argument-or-array-definition} rule. If there are no annotations on
...
of \code{Map.Entry<java.lang.String, java.lang.Obect>}.
