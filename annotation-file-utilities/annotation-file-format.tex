...
\qquad    \bnfor{} \bnfnt{class-declaration} \\
...
\qquad    \bnfor{} \bnfnt{method-declaration} \\
...
\\
\bnfnt{class-declaration} ::= \\
\qquad    \bnflit{Class} \bnflit{.} ( ( \bnflit{bound} \bnfnt{integer} ) \bnfor{} ( \bnflit{typeParameter} \bnfnt{integer} ) ) \\
\\
...
\\
\bnfnt{method-declaration} ::= \\
\qquad    \bnflit{Method} \bnflit{.} ( \bnflit{body} \bnfor{} ( \bnflit{parameter} \bnfnt{integer} ) \bnfor{} \bnflit{type} \bnfor{} ( \bnflit{typeParameter} \bnfnt{integer} ) ) \\
\\
