...
\subsection{Code Locations\label{code-locations}}
...
expression, plus a zero-based index to indicate which occurence of that kind of
...
takes an AST node and returns \code{true} if the AST node satisifies the
