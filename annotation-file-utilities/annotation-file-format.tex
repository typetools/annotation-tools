...
Internally, a \code{.jaif} file is represented by the class
\code{scene-lib/src/annotations/el/AScene.java}. The \code{AScene} class (or
...
\code{scene-lib/src/annotations/el/}.
