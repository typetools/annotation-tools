...
\qquad    \bnflit{extends} \bnflit{:} \lineend  \\
...
\qquad    \bnflit{implements} \bnfnt{integer} \bnflit{:} \lineend  \\
\qquad        \bnfnt{type-annotations}* \\
\\
...
\qquad    \bnfcmt contain generic type information. Using \code{javap -s} makes it easy to find the signature.\\
