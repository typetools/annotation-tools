...
We use the hash key (``\#'') for comments within the grammar. 
...
% TODO: something seems to be missing.
...
% TODO: is this also for constructors?
...
\qquad    \bnfcmt The annotation on the \bnflit{parameter} line is that of the parameter declaration, \\
\qquad    \bnfcmt while the annotation on the \bnflit{type} line is that of outermost type of the parameter. \\
...
% TODO: add a type here to distinguish declaration and type annotations, i.e.
% change next line to type-annotations
\qquad    \bnfnt{type-argument-or-array-definition}* \\
\\
...
% TODO: \item Annotations: \bnflit{@} followed by the annotation name.
