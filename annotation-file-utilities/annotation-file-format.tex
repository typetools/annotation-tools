...
\author{\url{http://types.cs.washington.edu/annotation-file-utilities/} \\ \today}
...
\qquad    \bnfcmt The integer list here contains the values of the ``location'' array~\cite{JSR308}. \\ % Section 4.3.12
