...
public class InnerReceivers {
    ...
    void m2(resources.unannotated.InnerReceivers this) {}
    ...
    class Inner1<Y, Z> {
        ...
        void m2(resources.unannotated.InnerReceivers.Inner1<Y, Z> this) {}
    ...
    static class StaticInner1 {
        ...
        void m2(resources.unannotated.InnerReceivers.StaticInner1 this) {}
    }
    ...
    static class StaticInner3<Y, Z> {
        ...
        void m2(resources.unannotated.InnerReceivers.StaticInner3<Y, Z> this) {}
    }
}
...
class Outer<K> {
    static class StaticInner2 {
        ...
        void m2(resources.unannotated.Outer.StaticInner2 this) {}
