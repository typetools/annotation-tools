...
public class TestBigDump implements Opcodes {
  ...
  public static byte[] dump() throws Exception {
    ...
    classWriter.visit(V1_8, ACC_SUPER, "experiment/TestBig", "<T1:Lexperiment/Super2<Lexperiment/T3<Lexperiment/T2;>;>;>Lexperiment/Super3<Lexperiment/Super4;>;", "experiment/Super3", null);
    ...
    {
      annotationVisitor0 = classWriter.visitTypeAnnotation(0x10FFFF00, null, "Lexperiment/Annotations$F;", false);
      annotationVisitor0.visitEnd();
    }
    {
      annotationVisitor0 = classWriter.visitTypeAnnotation(0x10FFFF00, TypePath.fromString("0;"), "Lexperiment/Annotations$G;", false);
      annotationVisitor0.visitEnd();
    }
    {
    ...
    {
      annotationVisitor0 = classWriter.visitTypeAnnotation(0x11000000, null, "Lexperiment/Annotations$C;", false);
      annotationVisitor0.visitEnd();
    }
    {
      annotationVisitor0 = classWriter.visitTypeAnnotation(0x11000000, TypePath.fromString("0;"), "Lexperiment/Annotations$D;", false);
      annotationVisitor0.visitEnd();
    }
    {
      annotationVisitor0 = classWriter.visitTypeAnnotation(0x11000000, TypePath.fromString("0;0;"), "Lexperiment/Annotations$E;", false);
      annotationVisitor0.visitEnd();
    }
    ...
    classWriter.visitInnerClass("experiment/Annotations$F", "experiment/Annotations", "F", ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

    classWriter.visitInnerClass("experiment/Annotations$G", "experiment/Annotations", "G", ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);
