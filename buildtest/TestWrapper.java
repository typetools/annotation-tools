...
/**
 * TestWrapper is a class that examines JUnit test results and outputs reports only if one or more
 * tests failed.
 */
public class TestWrapper {

  /**
   * Prints each file listed in args to standard out, only if it contained a failed JUnit test.
   *
